import {ArrowRight, BellRing, Boxes, Database, FolderTree, HardDrive, Layers3, MessageSquareMore, Settings2} from "lucide-react";
...
const SECTION_LINKS = [
  ...
  {
    href: "/admin/notify-center",
    label: "通知中心",
    summary: "统一管理 Telegram 通知、测试消息与双向机器人控制入口。",
